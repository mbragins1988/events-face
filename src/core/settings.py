...
NOTIFICATIONS_OWNER_ID = os.getenv("NOTIFICATIONS_OWNER_ID")
...
SIMPLE_JWT = {
    ...
    # При обновлении токена выдается новый Refresh Token
    "ROTATE_REFRESH_TOKENS": True,
    # Старый Refresh Token попадает в черный список
